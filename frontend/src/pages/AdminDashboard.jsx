...
import { API_BASE_URL, getAuthHeaders, getDecodedToken, clearToken, isAuthenticated } from '../utils/api';
        ...
        <div style={styles.container}>
            ...
            <aside style={styles.sidebar}>
                ...
                <nav style={styles.nav}>
                    ...
                    <div style={styles.navItem} onClick={() => { clearToken(); navigate('/login'); }}>Logout</div>
                </nav>
            </aside>
