...
import { API_BASE_URL, getAuthHeaders, getDecodedToken } from '../utils/api';
    ...
    const handleDeleteVehicle = async (id) => {
        if (window.confirm('Hapus kendaraan ini?')) {
            try {
                ...
                console.error(err);
                alert('Gagal menghapus kendaraan. Pastikan Anda memiliki izin admin.');
            }
        }
    };
                            ...
                            <tbody>
                                {vehicles.map((v) => (
                                    <tr key={v.id}>
                                        ...
                                        <td>Rp {Number(v.price_per_day).toLocaleString('id-ID')}</td>
                                        <td>
